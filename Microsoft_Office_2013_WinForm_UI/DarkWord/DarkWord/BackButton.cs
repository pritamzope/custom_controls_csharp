...
namespace DarkWord
{
    public class BackButton : System.Windows.Forms.Button
    {
        ...
        {
            base.OnPaint(pe);
            pe.Graphics.FillRectangle(new SolidBrush(Color.FromArgb(15,15,15)), ClientRectangle);
            pe.Graphics.FillEllipse(new SolidBrush(Color.FromArgb(15, 15, 15)), 8, 4, 35, 35);
