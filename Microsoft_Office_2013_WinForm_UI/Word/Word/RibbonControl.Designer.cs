namespace Word
{
    partial class RibbonControl
    {
        ...
        {
            this.FileButton = new Word.ButtonZ();
            this.HomeButton = new Word.TabButton();
            this.panel1 = new System.Windows.Forms.Panel();
            this.ViewButton = new Word.TabButton();
            this.ReviewButton = new Word.TabButton();
            this.MailingsButton = new Word.TabButton();
            this.ReferencesButton = new Word.TabButton();
            this.PageLayoutButton = new Word.TabButton();
            this.DesignButton = new Word.TabButton();
            this.InsertButton = new Word.TabButton();
            this.tabPanel = new Word.TabPanel();
