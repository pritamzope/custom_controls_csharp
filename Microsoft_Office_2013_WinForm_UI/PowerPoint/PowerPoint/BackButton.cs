...
namespace PowerPoint
{
    public class BackButton : System.Windows.Forms.Button
    {
        ...
        {
            base.OnPaint(pe);
            pe.Graphics.FillRectangle(new SolidBrush(Color.FromArgb(220, 70, 40)), ClientRectangle);
            pe.Graphics.FillEllipse(new SolidBrush(Color.FromArgb(220, 70, 40)), 8, 4, 35, 35);
