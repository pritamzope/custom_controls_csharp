namespace PowerPoint
{
    partial class FileOptionsControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.OptionsButton = new PowerPoint.OptionButton();
            this.AccountButton = new PowerPoint.OptionButton();
            this.CloseButton = new PowerPoint.OptionButton();
            this.ExportButton = new PowerPoint.OptionButton();
            this.ShareButton = new PowerPoint.OptionButton();
            this.PrintButton = new PowerPoint.OptionButton();
            this.SaveAsButton = new PowerPoint.OptionButton();
            this.SaveButton = new PowerPoint.OptionButton();
            this.OpenButton = new PowerPoint.OptionButton();
            this.NewButton = new PowerPoint.OptionButton();
            this.InfoButton = new PowerPoint.OptionButton();
            this.backButton1 = new PowerPoint.BackButton();
