...
namespace PowerPoint
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            wordTabControl.TransitionsButton.Click += new EventHandler(this.PageLayoutButton_Click);
            wordTabControl.AnimationsButton.Click += new EventHandler(this.ReferencesButton_Click);
            wordTabControl.SlideShowButton.Click += new EventHandler(this.MailingsButton_Click);
