namespace Excel
{
    partial class ControlBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.helpButton = new Excel.ButtonZ();
            this.minButton = new Excel.ButtonZ();
            this.minMaxButton = new Excel.MinMaxButton();
            this.closeButton = new Excel.ButtonZ();
            ...
            this.minMaxButton.CFormState = Excel.MinMaxButton.CustomFormState.Normal;
