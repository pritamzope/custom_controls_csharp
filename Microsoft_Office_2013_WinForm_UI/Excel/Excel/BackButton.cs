...
namespace Excel
{
    public class BackButton : System.Windows.Forms.Button
    {
        ...
        {
            base.OnPaint(pe);
            pe.Graphics.FillRectangle(new SolidBrush(Color.FromArgb(40, 110, 70)), ClientRectangle);
            pe.Graphics.FillEllipse(new SolidBrush(Color.FromArgb(40, 110, 70)), 8, 4, 35, 35);
